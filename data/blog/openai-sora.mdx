...
<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    <iframe 
      src="https://player.vimeo.com/video/913331489?h=d6b3d4c2bd" 
      width="640" 
      height="360" 
      frameBorder="0" 
...
<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  ...
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    <iframe 
      src="https://player.vimeo.com/video/913133210?h=be057e0e48" 
      width="640" 
      height="360" 
      frameBorder="0" 
      allow="autoplay; fullscreen" 
...
*some example of a hyper-realistic AI-generated video of  by Sora.*
...
<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    <iframe 
      src="https://player.vimeo.com/video/913132493?h=efc0bcf645" 
      width="640" 
      height="360" 
      frameBorder="0" 
      allow="autoplay; fullscreen" 
  ...
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    <iframe 
      src="https://player.vimeo.com/video/913130577?h=d425e21e09" 
      width="640" 
      height="360" 
      frameBorder="0" 
      allow="autoplay; fullscreen" 
...
<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    <iframe 
      src="https://player.vimeo.com/video/913340578?h=29747297c7" 
      width="640" 
      height="360" 
      frameBorder="0" 
      allow="autoplay; fullscreen" 
  ...
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    <iframe 
      src="https://player.vimeo.com/video/913344953?h=109b9ea63a" 
      width="640" 
      height="360" 
      frameBorder="0" 
      allow="autoplay; fullscreen" 
...
For more information and to read the full blog post, visit the [OpenAI blog](https://openai.com/sora).
